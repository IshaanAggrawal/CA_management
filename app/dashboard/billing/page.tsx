    ...
    <>
        ...
        <div className="glass-card p-6 rounded-xl flex flex-col justify-between overflow-hidden relative group transition-transform hover:-translate-y-1">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="font-display-lg text-display-lg text-error">₹24,85,200</h3>
            </div>
        ...
        <div className="glass-card p-6 rounded-xl flex flex-col justify-between overflow-hidden relative group transition-transform hover:-translate-y-1">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="font-display-lg text-display-lg text-primary">₹68,12,000</h3>
            </div>
          ...
          <div className="flex items-center gap-2 text-on-tertiary-container font-label-sm text-label-sm">
            ...
            <span>145 invoices generated</span>
          </div>
          <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
        ...
        <div className="glass-card p-6 rounded-xl flex flex-col justify-between overflow-hidden relative group transition-transform hover:-translate-y-1">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="font-display-lg text-display-lg text-on-tertiary-container">92.4%</h3>
            </div>
          ...
          <div className="w-full bg-surface-container-high h-2 rounded-full overflow-hidden">
            <div className="bg-on-tertiary-container h-full rounded-full" style={{ width: "92.4%" }}></div>
          </div>
          <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
      ...
      <section className="glass-card rounded-xl overflow-hidden shadow-sm">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-outline-variant bg-white">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-primary-fixed flex items-center justify-center text-primary font-bold text-xs">GK</div>
                    <span className="font-body-md text-body-md font-semibold text-on-surface">Global Kinetix Ltd.</span>
                  </div>
                </td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">#INV-2023-890</td>
                <td className="px-6 py-4 font-body-md text-body-md font-bold">₹1,45,000</td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">Oct 12, 2023</td>
                <td className="px-6 py-4">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-secondary-container flex items-center justify-center text-on-secondary-container font-bold text-xs">SV</div>
                    <span className="font-body-md text-body-md font-semibold text-on-surface">Stellar Ventures</span>
                  </div>
                </td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">#INV-2023-912</td>
                <td className="px-6 py-4 font-body-md text-body-md font-bold">₹82,500</td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">Oct 28, 2023</td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button className="p-1.5 text-on-surface-variant hover:bg-surface-container-high rounded-md transition-colors cursor-pointer" title="View Receipt">
              ...
              <tr className="hover:bg-surface-container-low transition-colors group">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-surface-container-highest flex items-center justify-center text-on-surface-variant font-bold text-xs">AN</div>
                    <span className="font-body-md text-body-md font-semibold text-on-surface">Alpha Networks</span>
                  </div>
                </td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">#INV-2023-944</td>
                <td className="px-6 py-4 font-body-md text-body-md font-bold">₹2,10,000</td>
                <td className="px-6 py-4 font-body-sm text-body-sm text-on-surface-variant">Nov 05, 2023</td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button className="p-1.5 text-on-surface-variant hover:bg-surface-container-high rounded-md transition-colors cursor-pointer" title="Send Reminder">
        ...
        <div className="p-6 bg-surface-container-lowest border-t border-outline-variant flex items-center justify-between">
          <span className="font-label-sm text-label-sm text-on-surface-variant">Showing 1-10 of 145 invoices</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        <div className="glass-card p-6 rounded-xl border-secondary/20 bg-secondary-container/5 relative overflow-hidden">
          ...
          <div className="space-y-3 relative z-10">
            <div className="flex items-center justify-between p-3 bg-white/80 rounded-lg border border-outline-variant hover:border-secondary transition-all cursor-pointer group">
              <div className="flex items-center gap-3">
                <div className="text-error"><span className="material-symbols-outlined">warning</span></div>
                <div>
                  <p className="font-label-md text-label-md text-on-surface">Global Kinetix Ltd.</p>
                  <p className="font-label-sm text-label-sm text-on-surface-variant">₹1,45,000 • 22 days overdue</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white/80 rounded-lg border border-outline-variant hover:border-secondary transition-all cursor-pointer group">
              <div className="flex items-center gap-3">
                <div className="text-error"><span className="material-symbols-outlined">warning</span></div>
                <div>
                  <p className="font-label-md text-label-md text-on-surface">Blue Planet Org</p>
                  <p className="font-label-sm text-label-sm text-on-surface-variant">₹5,12,000 • 35 days overdue</p>
                </div>
              </div>
              <span className="material-symbols-outlined text-secondary opacity-0 group-hover:opacity-100 transition-opacity">send</span>
            </div>
